...
// Labs
add_courses("cloud", "2280404", "lab", 4);
add_courses("java", "2280426", "lab", 1);
...
// Online Classes
add_courses("ICTK", "1000001", "online", 1);
// add_courses("Online2", "1000001", "online", 1);

// MAC
add_courses("language", "3000004", "mac", 0);
// add_courses("MAC2", "3000004", "mac", 0);

// Theory Classes
add_courses("MATH", "2280421", "theory", 1);
add_courses("IS", "2280425", "theory", 1);
add_courses("MCA", "2280422", "theory", 1);
add_courses("SE", "2280423", "theory", 1);
...
add_faculty("TS", ["2280422", "280601", "280602", "280603", "270601"]);
...
add_faculty("SM", ["2280423", "3240224", "3240225", "2270424", "2270426"]);
...
add_faculty("NT", ["1000001", "2280404", "2270424", "2270426"]);
// add_faculty("GS", ["2240424", "280601", "280602", "280603", "270601"]);
// add_faculty("NA", ["270603", "270602", "240602", "240603", "280604"]);
add_faculty("RS", ["2280425", "1000001", "3000002", "3000004", "240601"]);
add_faculty("JKM", ["2280421", "2270421", "2240423", "3240224", "3240225"]);
add_faculty("RKJ", ["240604","2280426", "3240223", "3270225", "2270423"]);
